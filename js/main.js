 ...
 * pre-built PDF that the "Generate PDF exports" GitHub Action produces on
 * every push to main (cv-pt.pdf / cv-en.pdf at the repo root) — that file is
 * guaranteed selectable/clickable because it was generated by Chrome's own
 * PDF engine server-side, never routed through a system print driver.
 *
